...
from source.indicators import DonchainChannelsIndicatorHandler, MovingVolumeProfileIndicatorHandler, StochasticOscillatorIndicatorHandler
...
async def main(trading_pair, start_date, end_date, granularity_str, list_of_indicators_str):
    try:
        ...
        file_name = f'DS_{trading_pair}_{start_date}_{end_date}_{granularity_str}_{list_of_indicators_str}.csv'.replace(' ', '_')
...
if __name__ == "__main__":
    ...
    asyncio.run(main(args.trading_pair, args.start_date, args.end_date, args.granularity, args.list_of_indicators))
